...
SECRET_KEY = 'django-insecure-ni$q1$3=ro$5k+_yc#82it(0n@i&_z81_6@j%e!2f=&&t@ko36'
...
TEMPLATES = [
    {
        ...
        #templates -> user's templates then write os.path.join(BASE_DIR,"users/templates")
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
